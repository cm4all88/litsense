...
/* ── BOOK COVER ── */
.ls-book-cover{width:72px;min-width:72px;height:104px;border-radius:9px;overflow:hidden;flex-shrink:0;box-shadow:0 4px 20px rgba(0,0,0,.5);position:relative;}
          ...
          return (
            ...
            >
              <BookCover
                ...
                style={{width:"100%",height:"100%",minWidth:"unset",borderRadius:0,boxShadow:"none"}}
              />
              {/* Saved pip */}
              {isSaved && (
                <div style={{
  ...
  return (
    ...
    >
      <div style={{
        ...
        borderRadius: hovered ? 14 : 10,
        overflow: "hidden", position: "relative",
        background: hovered ? "rgba(10,8,6,.95)" : "transparent",
        boxShadow: hovered
          ? "0 20px 56px rgba(0,0,0,.85), 0 0 0 1.5px rgba(212,148,26,.45), 0 0 24px rgba(212,148,26,.12)"
          : scrollScale > 1.05
        ...
        {/* Conviction overlay — fills full expanded tile */}
        <div style={{
          position:"absolute", inset:0,
          background: hovered
            ? "linear-gradient(to top,rgba(10,8,6,1) 0%,rgba(10,8,6,1) 50%,rgba(10,8,6,.92) 62%,rgba(10,8,6,.5) 78%,transparent 92%)"
            : "transparent",
          ...
          <div style={{fontSize:12, fontWeight:700, color:"rgba(255,255,255,.95)", lineHeight:1.25, marginBottom:3, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{b.title}</div>
          <div style={{fontSize:10, color:"rgba(212,148,26,.8)", marginBottom:8}}>{b.author}</div>

          <div style={{fontSize:7, fontWeight:700, letterSpacing:"1.8px", textTransform:"uppercase", color:"rgba(212,148,26,.82)", marginBottom:5}}>
            Why this could be your next favorite
          </div>

          <div style={{
            fontSize:11, lineHeight:1.65, color:"rgba(240,232,216,.92)",
            marginBottom:9,
            overflow:"hidden",
            maxHeight:"7.5em",
        ...
        <div className="ls-logo">
          {isPro ? (
            ...
            <svg height="32" viewBox="0 0 1267.82 368.3" xmlns="http://www.w3.org/2000/svg" style={{width:"auto"}}>
              <defs><style>{`.lp1{fill:#931a1d}.lp2{fill:#fff;stroke:#fff;stroke-miterlimit:10}.lp3{fill:#dcbf35}`}</style></defs>
              <g><g>
            ...
            /* Standard logo */
            <svg height="32" viewBox="0 0 1267.82 368.3" xmlns="http://www.w3.org/2000/svg" style={{width:"auto"}}>
              <defs><style>{`.ls1{fill:#dcbf35}`}</style></defs>
              <g><g>
      ...
      <div className="ls-main">
        ...
        {tab==="discover" && (
          ...
          <div className="ls-scroll">
            ...
            {wheelBooks.length > 0 && (
              <div style={{ position:"relative", margin:"8px 0", minHeight: 420 }}>
                {/* Scene illustration — sits behind wheel, crossfades on swipe */}
                <div style={{
                  position:"absolute", top:0, left:0, right:0, bottom:0,
                  borderRadius:20, overflow:"hidden", zIndex:0,
                }}>

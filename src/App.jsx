...
function BookCover({ isbn, title, author = "", color = ["#1a1408","#0e0c06"], className = "", style = {} }) {
  ...
  // Use L size for better resolution in the wheel (M is too small at 200px wide)
        ...
        <div className="ls-logo">
          {isPro ? (
            ...
            <svg height="32" viewBox="0 0 1267.82 368.3" xmlns="http://www.w3.org/2000/svg" style={{width:"auto"}}>
              <defs><style>{`.lp1{fill:#931a1d}.lp2{fill:#fff;stroke:#fff;stroke-miterlimit:10}.lp3{fill:#dcbf35}.ls2{fill:#fff}`}</style></defs>
              <g><g>
            ...
            <svg height="32" viewBox="0 0 1267.82 368.3" xmlns="http://www.w3.org/2000/svg" style={{width:"auto"}}>
              <defs><style>{`.ls1{fill:#dcbf35}.ls2{fill:#fff}`}</style></defs>
              <g><g>
